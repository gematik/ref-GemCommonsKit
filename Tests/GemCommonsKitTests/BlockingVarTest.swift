...
final class BlockingVarTest: XCTestCase {
    ...
    static var allTests = [
        ("testBlockingVar", testBlockingVar),
        ("testBlockingVarOnMainThread", testBlockingVarOnMainThread),
        ("testBlockingVarOnMainThreadSetFromDifferentThread", testBlockingVarOnMainThreadSetFromDifferentThread)
    ]
}
